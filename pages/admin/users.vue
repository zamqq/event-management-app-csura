...
// Open delete modal
const handleDeleteUser = (userToDeleteParam) => {
  userToDelete.value = userToDeleteParam
  clearError()
  successMessage.value = ''
        ...
        <div class="mt-3">
          ...
          <div v-if="!successMessage" class="mb-6">
            <div class="flex items-center mb-4">
              ...
              <div class="ml-3">
                <h3 class="text-lg font-medium text-gray-900">Ești sigur că vrei să ștergi acest utilizator?</h3>
              </div>
            </div>
            <p class="text-sm text-gray-500 mb-2">
              Utilizatorul <strong>{{ userToDelete?.fullName }}</strong> ({{ userToDelete?.email }}) va fi șters permanent.
            </p>
          ...
          <!-- Form Actions -->
          <div v-if="!successMessage" class="flex justify-end space-x-3 pt-4">
            <button
              type="button"
              @click="handleCloseDeleteModal"
              @keydown="(event) => handleKeyDown(event, handleCloseDeleteModal)"
            ...
            >
              ...
              <span v-else>Șterge Utilizatorul</span>
            </button>
          </div>
        </div>
      </div>
